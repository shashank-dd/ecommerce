...
//   setTimeout(() => {
//       console.log("timeout")
//        setjrr(arr.slice(10*count,10*count+10))
//     },1);
...
if(e.target.value=="fragrances"){
  ...
  if(e.target.value=="skincare"){
    ...
    if(e.target.value=="homedecoration"){
      setjrr(homedecoration)
      return
      }
      if(e.target.value=="smartphones"){
        setjrr(smartphones)
        return
        }
...
useEffect(()=>{
  ...
  .then(res => res.json())
  .then( (res)=>{
    // let r= res.products.sort((a,b)=>{
    //   return a.rating-b.rating
    // })
    console.log(res.products,"r")
    setone(1)
    let d=[...res.products]
    console.log("d",d)
          // setarr( d)
          setjrr(arr.slice(10*count,10*count+10))
          console.log(arr,jrr,count)
  ...
  console.log(jrr,one,"hjfkjgbhvv")
  return (
    <div className="App">
     <h1>Awailable products</h1>
     <h2 >YOU are in homepage click on next to go to 1st page</h2>
...
return <div key={i} className="container">
 <img src={res.images[0]} ></img>
 <div className="fl">
 <img src={res.images[0]} className="yt"></img>
 <div className='pp'>  <p>brand:{res.brand}</p>
